...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAkGameplayStatics_GetOcclusionScalingFactor_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audiokinetic" },
		{ "Comment", "/**\n\x09* Allows to globally tweak the occlusion with a multiplicative factor.\n\x09*/" },
		{ "ModuleRelativePath", "Classes/AkGameplayStatics.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAkGameplayStatics_GetSpeakerAngles_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audiokinetic" },
		{ "Comment", "/**\n\x09 * Gets speaker angles of the specified device. Speaker angles are used for 3D positioning of sounds over standard configurations.\n\x09 * Note that the current version of Wwise only supports positioning on the plane.\n\x09 * The speaker angles are expressed as an array of loudspeaker pairs, in degrees, relative to azimuth ]0,180].\n\x09 * Supported loudspeaker setups are always symmetric; the center speaker is always in the middle and thus not specified by angles.\n\x09 * Angles must be set in ascending order.\n\x09 * Typical usage:\n\x09 * - float heightAngle;\n\x09 * - TArray<float> speakerAngles;\n\x09 * - GetSpeakerAngles(speakerAngles, heightAngle, AkOutput_Main );\n\x09 * \\aknote\n\x09 *  On most platforms, the angle set on the plane consists of 3 angles, to account for 7.1.\n\x09 * - When panning to stereo (speaker mode, see <tt>AK::SoundEngine::SetPanningRule()</tt>), only angle[0] is used, and 3D sounds in the back of the listener are mirrored to the front.\n\x09 * - When panning to 5.1, the front speakers use angle[0], and the surround speakers use (angle[2] - angle[1]) / 2.\n\x09 * \\endaknote\n\x09 * \\warning Call this function only after the sound engine has been properly initialized.\n\x09 *\n\x09 * @param SpeakerAngles Returned array of loudspeaker pair angles, in degrees relative to azimuth [0,180]. Pass NULL to get the required size of the array.\n\x09 * @param HeightAngle Elevation of the height layer, in degrees relative to the plane [-90,90].\n\x09 * @param DeviceShareset Shareset for which to get the angles. You can pass \"\" for the main (default) output\n\x09 * @return AK_Success if device exists\n\x09 *\n\x09 */" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAkGameplayStatics_SetSpeakerAngles_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audiokinetic" },
		{ "Comment", "/**\n\x09 * Sets speaker angles of the specified device. Speaker angles are used for 3D positioning of sounds over standard configurations.\n\x09 * Note that the current version of Wwise only supports positioning on the plane.\n\x09 * The speaker angles are expressed as an array of loudspeaker pairs, in degrees, relative to azimuth ]0,180].\n\x09 * Supported loudspeaker setups are always symmetric; the center speaker is always in the middle and thus not specified by angles.\n\x09 * Angles must be set in ascending order.\n\x09 * Typical usage:\n\x09 * - Initialize the sound engine and/or add secondary output(s).\n\x09 * - Get number of speaker angles and their value into an array using GetSpeakerAngles().\n\x09 * - Modify the angles and call SetSpeakerAngles().\n\x09 * This function posts a message to the audio thread through the command queue, so it is thread safe. However the result may not be immediately read with GetSpeakerAngles().\n\x09 * \\warning This function only applies to configurations (or subset of these configurations) that are standard and whose speakers are on the plane (2D).\n\x09 * \\sa GetSpeakerAngles()\n\x09 *\n\x09 * @param SpeakerAngles Array of loudspeaker pair angles, in degrees relative to azimuth [0,180]\n\x09 * @param HeightAngle Elevation of the height layer, in degrees relative to the plane [-90,90]\n\x09 * @param DeviceShareset Shareset for which to set the angles on. You can pass \"\" for the main (default) output\n\x09 * @return AK_Success if successful (device exists and angles are valid), AK_NotCompatible if the channel configuration of the device is not standard (AK_ChannelConfigType_Standard), AK_Fail otherwise.\n\x09 *\n\x09 */" },
		{ "CPP_Default_DeviceShareset", "" },
		{ "ModuleRelativePath", "Classes/AkGameplayStatics.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAkGameplayStatics_SpawnAkComponentAtLocation_Statics::Function_MetaDataParams[] = {
		{ "AdvancedDisplay", "6" },
		{ "Category", "Audiokinetic" },
		{ "Comment", "/** Spawn an AkComponent at a location. Allows, for example, to set a switch on a fire and forget sound.\n\x09 * @param AkEvent - Wwise Event to post.\n\x09 * @param EarlyReflectionsBus - Use the provided auxiliary bus to process early reflections.  If NULL, EarlyReflectionsBusName will be used.\n\x09 * @param Location - Location from which to post the Wwise Event.\n\x09 * @param Orientation - Orientation of the event.\n\x09 * @param AutoPost - Automatically post the event once the AkComponent is created.\n\x09 * @param EarlyReflectionsBusName - Use the provided auxiliary bus to process early reflections.  If empty, no early reflections will be processed.\n\x09 * @param AutoDestroy - Automatically destroy the AkComponent once the event is finished.\n\x09 */" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAkGameplayStatics_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UAkGameplayStatics_GetOcclusionScalingFactor, "GetOcclusionScalingFactor" }, // 2918557582
		{ &Z_Construct_UFunction_UAkGameplayStatics_GetRTPCValue, "GetRTPCValue" }, // 2921737234
		{ &Z_Construct_UFunction_UAkGameplayStatics_GetSpeakerAngles, "GetSpeakerAngles" }, // 251915203
		...
		{ &Z_Construct_UFunction_UAkGameplayStatics_SetOcclusionScalingFactor, "SetOcclusionScalingFactor" }, // 4233117400
		...
		{ &Z_Construct_UFunction_UAkGameplayStatics_SetSpeakerAngles, "SetSpeakerAngles" }, // 46993302
		...
		{ &Z_Construct_UFunction_UAkGameplayStatics_SpawnAkComponentAtLocation, "SpawnAkComponentAtLocation" }, // 2711043063
		...
		{ &Z_Construct_UFunction_UAkGameplayStatics_UseEarlyReflections, "UseEarlyReflections" }, // 674628702
	...
	IMPLEMENT_CLASS(UAkGameplayStatics, 618575462);
