...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAkAssetDataWithMedia_Statics::NewProp_MediaList = { "MediaList", nullptr, (EPropertyFlags)0x0014000000020001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkAssetDataWithMedia, MediaList), METADATA_PARAMS(Z_Construct_UClass_UAkAssetDataWithMedia_Statics::NewProp_MediaList_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAkAssetDataWithMedia_Statics::NewProp_MediaList_MetaData)) };
	...
	IMPLEMENT_CLASS(UAkAssetDataWithMedia, 3323771209);
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UAkAssetPlatformData_Statics::NewProp_AssetDataPerPlatform = { "AssetDataPerPlatform", nullptr, (EPropertyFlags)0x0010000800020001, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkAssetPlatformData, AssetDataPerPlatform), METADATA_PARAMS(Z_Construct_UClass_UAkAssetPlatformData_Statics::NewProp_AssetDataPerPlatform_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAkAssetPlatformData_Statics::NewProp_AssetDataPerPlatform_MetaData)) };
	...
	IMPLEMENT_CLASS(UAkAssetPlatformData, 2325096385);
	...
	IMPLEMENT_CLASS(UAkAssetBase, 390128274);
